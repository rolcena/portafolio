...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I am A Freelancer.", "I am A Cerrista." , "I am A engineering student" , "I Design Websites.", "I Live in Paraguay."],    /* You can change the home section typing text from
